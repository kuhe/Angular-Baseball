...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AbstractMesh; });
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utility_utils__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Services_Distribution__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Services_Iterator__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_AtBat__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_TeamConstants__ = __webpack_require__(14);
...
Player.prototype = {
    ...
    init(team, hero) {
        ...
        const surnameKey = Math.floor(Math.random()*__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].surnames.length), nameKey = Math.floor(Math.random()*__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].names.length);

        this.name = `${__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].surnames[surnameKey]} ${__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].names[nameKey]}`;
        const jSurname = __WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].surnamesJ[surnameKey], jGivenName = __WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].namesJ[nameKey];
        this.spaceName(jSurname, jGivenName);
        this.surname = __WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].surnames[surnameKey];
        this.surnameJ = __WEBPACK_IMPORTED_MODULE_0__Utility_utils__["b" /* data */].surnamesJ[surnameKey];
        this.atBats = [];
    ...
    fromData(data) {
        const giraffe = this;
        __WEBPACK_IMPORTED_MODULE_3__Services_Iterator__["a" /* Iterator */].each(data, (key, value) => {
            giraffe[key] = value;
        });
    ...
    resetStats(gamesIntoSeason=72) {
        ...
        const randBetween = (a, b, skill) => {
            ...
            skill += '';
            if (!skill) skill = '';
            __WEBPACK_IMPORTED_MODULE_3__Services_Iterator__["a" /* Iterator */].each(skill.split(' '), (key, value) => {
                let skill = value;
    ...
    getAtBats() {
        if (this.atBats.length > this.atBatObjects.length) {
            this.atBatObjects = this.atBats.map(item => new __WEBPACK_IMPORTED_MODULE_4__Model_AtBat__["a" /* AtBat */](item));
        }
        return this.atBatObjects;
    },
    recordRBI() {
        this.atBats[this.atBats.length - 1] += __WEBPACK_IMPORTED_MODULE_4__Model_AtBat__["a" /* AtBat */].prototype.RBI_INDICATOR;
    },
    recordInfieldHit() {
        this.atBats[this.atBats.length - 1] += __WEBPACK_IMPORTED_MODULE_4__Model_AtBat__["a" /* AtBat */].prototype.INFIELD_HIT_INDICATOR;
    },
    /**
     * @returns {number}
     */
    getBaseRunningTime() {
        return __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].baseRunningTime(this.skill.offense.speed);
    },
    /**
     * live game steal
     * @param game
    ...
    attemptSteal(game, base) {
        ...
        const success = __WEBPACK_IMPORTED_MODULE_1__Services_Distribution__["a" /* Distribution */].stealSuccess(pitch, game.pitcher.team.positions.catcher,
            this, base, this.team.stealAttempt === __WEBPACK_IMPORTED_MODULE_5__Model_TeamConstants__["a" /* default */].RUNNERS_DISCRETION);
        if (success) {
     ...
     */
    getSurname() {
        return __WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode === 'n' ? this.surnameJ : this.surname;
    },
    /**
     * language-sensitive
     * @returns {String}
     */
    getName() {
        return __WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode === 'n' ? this.nameJ : this.name;
    },
    getUniformNumber() {
        return Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('#') + this.number;
    },
    /**
     ...
     */
    getOrder() {
        return Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])([' 1st', ' 2nd', ' 3rd', ' 4th', ' 5th', ' 6th', '7th', ' 8th', ' 9th'][this.order]);
    },
    /**
    ...
    getDefiningBattingCharacteristic() {
        if (!this.definingBattingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode]) {
            this.definingBattingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode] = this.getDefiningCharacteristic(true);
        }
        return this.definingBattingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode];
    },
    /**
    ...
    getDefiningPitchingCharacteristic() {
        if (!this.definingPitchingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode]) {
            this.definingPitchingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode] = this.getDefiningCharacteristic(false, true);
        }
        return this.definingPitchingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode];
    },
    /**
    ...
    getDefiningCharacteristic(battingOnly, pitchingOnly) {
        if (this.definingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode] && !battingOnly) {
            return this.definingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode];
        }
        let out = '';
        ...
        if (pitchingOnly || (pitcherRating > 90 && !battingOnly)) {
            if (pitcherRating > 94) {
                out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Ace');
            } else if (pitching[0] > EXCELLENT) {
                out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Control pitcher');
            } else if (pitching[1] > EXCELLENT) {
                out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Flamethrower');
            } else if (pitching[2] > EXCELLENT) {
                out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Breaking ball');
            }
        } else {
            if (battingOnly || sum([offense[0] * 2, offense[1] * 0.50, offense[2]]) > sum(defense)) {
                if (offense[0] > 98 || (sum(offense) > ELITE * 3)) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Genius batter');
                } else if (offense[1] > EXCELLENT && offense[1] > offense[0]) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Power hitter');
                } else if (offense[0] > EXCELLENT) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Contact');
                } else if (offense[2] > EXCELLENT) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Speedster');
                } else if (offense[0] < INEPT || (sum(offense) < POOR * 3)) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Inept');
                } else if (offense[1] < INEPT && offense[1] < offense[0]) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Weak swing');
                } else if (offense[0] < BAD) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Strikes out');
                } else if (offense[2] < POOR) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Leisurely runner');
                }
            } else {
                if (sum(defense) > EXCELLENT * 3) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Defensive wizard');
                } else if (defense[0] > EXCELLENT) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Glove');
                } else if (defense[1] > EXCELLENT) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Range');
                } else if (defense[2] > ELITE) {
                    out = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */])('Strong throw');
                }
            }
        }
        if (battingOnly || pitchingOnly) return out;
        return this.definingCharacteristic[__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["d" /* text */].mode] = out;
    },
    /**
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Mathinator; });
/**
 * For Math!
 * @constructor
 */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utility_data__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Utility_helper__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utility_Log__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Utility_text__ = __webpack_require__(8);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__Utility_data__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_1__Utility_helper__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_2__Utility_Log__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_3__Utility_text__["b"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utility_helper__ = __webpack_require__(6);

const pitchDefinitions = __WEBPACK_IMPORTED_MODULE_0__Utility_helper__["a" /* helper */].pitchDefinitions;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utility_text__ = __webpack_require__(8);
...
Log.prototype = {
    ...
    note(note, noteJ, only) {
        ...
        if (only === 'e') {
            ...
            this.record.n.unshift(noteJ);
            this.async(() => {
                if (__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode === 'n') {
                    console.log(noteJ);
                } else {
                    console.log(note);
                }
    ...
    getBatter(batter) {
        ...
        order = {
            0 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 1st'),
            1 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 2nd'),
            2 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 3rd'),
            3 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 4th'),
            4 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 5th'),
            5 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 6th'),
            6 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 7th'),
            7 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 8th'),
            8 : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' 9th')
        }[order];
        const positions = this.longFormFielder();
        return Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Now batting')+order+__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma()+positions[batter.position]+__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma()+
            batter.getUniformNumber()+__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma()+
            batter.getName();
    },
    noteBatter(batter) {
        const m = __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode;
        let record;
        let recordJ;
        __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode = 'e';
        record = this.getBatter(batter);
        __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode = 'n';
        recordJ = this.getBatter(batter);
        __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode = m;
    ...
    getPitchLocationDescription(pitchInFlight, batterIsLefty) {
        ...
        if (x < 50) {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('way outside');
            ball = true;
        } else if (x < 70) {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('outside');
        } else if (x < 100) {
            say += '';
            noComma = true;
        } else if (x < 130) {
            ...
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('inside');
        } else {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('way inside');
            ball = true;
        }
        if (say) say += __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma();
        if (y < 35) {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('way low');
            ball = true;
        } else if (y < 65) {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('low');
        } else if (y < 135) {
            say += '';
            noComma2 = true;
        } else if (y < 165) {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('high');
        } else {
            say += Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('way high');
            ball = true;
        }
        if (noComma || noComma2) {
            say = say.split(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma()).join('');
            if (noComma && noComma2) {
                say = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('down the middle');
            }
        }
        // say = (ball ? 'Ball, ' : 'Strike, ') + say;
        say = __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].namePitch(pitchInFlight) + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma() + say + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop();
        return say;
    },
    ...
    broadcastCount(justOuts) {
        ...
        if (this.lastOuts == 2 && count.outs == 0) {
            outs = 3 + Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' outs');
        } else {
            var outs = count.outs + (count.outs == 1 ? Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' out') : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' outs'));
        }
        this.lastOuts = count.outs;
        if (justOuts) {
            return outs + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop();
        }
        return `${this.game.getInning()}: ${count.strikes}-${count.balls}, ${outs}${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop()}`;
    },
    broadcastScore() {
        return `${this.game.teams.away.getName()} ${this.game.tally.away.R}, ${this.game.teams.home.getName()} ${this.game.tally.home.R}${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop()}`;
    },
    broadcastRunners() {
        const field = this.game.field;
        const runners = [
            field.first && Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('first') || '',
            field.second && Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('second') || '',
            field.third && Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('third') || ''
        ].filter(x => x);
        ...
        switch (runnerCount) {
            case 0:
                return Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Bases empty') + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop();
            case 1:
                return `${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Runner on')}: ${runners.join(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma())}${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop()}`;
            default:
                return `${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Runners on')}: ${runners.join(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma())}${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop()}`;
        }
    },
    getSwing(swingResult) {
        ...
        if (swingResult.looking) {
            if (swingResult.strike) {
                result += `<span class="txt-orange">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Strike.')}</span>`;
            } else {
                result += `<span class="txt-green">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Ball.')}</span>`;
            }
        } else {
            const timing = [
                'Very late',
            ...
            if (timing) {
                result += '('+Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(timing)+')' + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].space();
            }

            if (swingResult.contact) {
                if (swingResult.foul) {
                    result += `<span class="txt-orange">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Fouled off.')}</span>`;
                } else {
                    if (swingResult.caught) {
                        result += `<span class="txt-blue">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('In play.')}</span>`;
                    } else {
                ...
                result += `<span class="txt-orange">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Swinging strike.')}</span>`;
            }
        }
        let steal = '';
        ...
        if (steal) {
            this.note(steal, steal, __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode);
        }
        return result + steal;
    },
    ...
    noteStealAttempt(thief, success, base) {
        return `${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].space() + thief.getName() + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].comma()
    + (success ? Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('stolen base') : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('caught stealing')) + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].space()}(${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].baseShortName(base)})${__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].stop()}`;
    },
    noteSubstitution(sub, player) {
        return this.note(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].substitution(sub, player, 'e'), __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].substitution(sub, player, 'n'));
    },
    getPlateAppearanceResult(game) {
        ...
        if (r.looking) {
            if (r.strike) {
                record = (batter + `<span class="txt-red">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' struck out looking.')}</span>`);
            } else {
                record = (batter + `<span class="txt-blue">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' walked.')}</span>`);
            }
            let steal = '';
            const lineup = this.game.batter.team.lineup;
            ...
            if (r.contact) {
                ...
                record = __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].contactResult(batter, fielder, bases, outBy, r.outs === 3 ? [] : r.sacrificeAdvances, out);
            } else {
                record = (batter + `<span class="txt-red">${Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])(' struck out swinging.')}</span>`);
            }
        }
        return record;
    },
    notePlateAppearanceResult(game) {
        const m = __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].mode, prevJ = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Previous: ', 'n'), prev = Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('Previous: ', 'e');
        ...
        statement = prev + this.lastSwing + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].space() + result;
        ...
        statement = prevJ + this.lastSwingJ + __WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */].space() + resultJ;
    ...
    longFormFielder() {
        return {
            first : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('first baseman'),
            second : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('second baseman'),
            third : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('third baseman'),
            short : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('shortstop'),
            pitcher : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('pitcher'),
            catcher : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('catcher'),
            left : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('left fielder'),
            center : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('center fielder'),
            right : Object(__WEBPACK_IMPORTED_MODULE_0__Utility_text__["b" /* text */])('right fielder')
        }
    }
};
...
/* harmony export (immutable) */ __webpack_exports__["a"] = abbreviatePosition;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Render_Loop__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utility_helper__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Render_LoopConstants__ = __webpack_require__(10);
...
Animator.prototype = {
     ...
     */
    beginRender() {
        this.background = new __WEBPACK_IMPORTED_MODULE_1__Render_Loop__["a" /* Loop */]('webgl-bg-container', true, Animator);
        this.loop = new __WEBPACK_IMPORTED_MODULE_1__Render_Loop__["a" /* Loop */]('webgl-container', false, Animator);
    ...
    tweenFlightPath(callback, $scope) {
        ...
        const pitchTransition = __WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__["a" /* Mathinator */].pitchTransition(top, left, originTop, originLeft, quarter, 12, 4), targetTransition = __WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__["a" /* Mathinator */].pitchTransition(top, left, originTop, originLeft, quarter, 10, 3);
    ...
    renderFlightPath(callback, $scope) {
        ...
        TweenMax.killAll();
        const game = $scope.y,
              flightSpeed = __WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__["a" /* Mathinator */].getFlightTime(game.pitchInFlight.velocity,
                  __WEBPACK_IMPORTED_MODULE_2__Utility_helper__["a" /* helper */].pitchDefinitions[game.pitchInFlight.name][2]);
    ...
    tweenFieldingTrajectory(game, splayOnly) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__["a" /* Mathinator */].memory.bounding = angle < 0;
        ...
        const velocityVerticalComponent = Math.sin(__WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__["a" /* Mathinator */].RADIAN * angle) * velocity;
        ...
        const mathinator = new __WEBPACK_IMPORTED_MODULE_0__Services_Mathinator__["a" /* Mathinator */]();
        let transitions = [
    ...
    renderFieldingTrajectory(game) {
        ...
        if (result.thrownOut || result.caught || result.bases) {
            if ((Math.random() < 0.15 && ball.airTime > 1.5)
                ...
                this.loop.setMoveTarget({x: 0, y: 6, z: __WEBPACK_IMPORTED_MODULE_3__Render_LoopConstants__["a" /* INITIAL_CAMERA_DISTANCE */]}, 0.05);
            }
...
/* harmony export (immutable) */ __webpack_exports__["b"] = VERTICAL_CORRECTION;

const INITIAL_CAMERA_DISTANCE = 8;
/* harmony export (immutable) */ __webpack_exports__["a"] = INITIAL_CAMERA_DISTANCE;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Player__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Model_Manager__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Utility_utils__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TeamConstants__ = __webpack_require__(14);
...
__WEBPACK_IMPORTED_MODULE_3__TeamConstants__["a" /* default */].RUNNERS_DISCRETION = 'runnersDiscretion';
__WEBPACK_IMPORTED_MODULE_3__TeamConstants__["a" /* default */].RUNNER_GO = 'go';
__WEBPACK_IMPORTED_MODULE_3__TeamConstants__["a" /* default */].RUNNER_HOLD = 'hold';
...
Team.prototype = {
    ...
    init(game, heroRate) {
        ...
        this.manager = new __WEBPACK_IMPORTED_MODULE_1__Model_Manager__["a" /* Manager */](this);
        if (game !== 'no init') {
            this.game = game;
            for (let j = 0; j < 20; j++) {
                this.bench.push(new __WEBPACK_IMPORTED_MODULE_0__Model_Player__["a" /* Player */](this, Math.random() < heroRate));
            }
    ...
    pickName() {
        const teamNameIndex = Math.floor(Math.random()*__WEBPACK_IMPORTED_MODULE_2__Utility_utils__["b" /* data */].teamNames.length);
        this.name = __WEBPACK_IMPORTED_MODULE_2__Utility_utils__["b" /* data */].teamNames[teamNameIndex];
        this.nameJ = __WEBPACK_IMPORTED_MODULE_2__Utility_utils__["b" /* data */].teamNamesJ[teamNameIndex];
    },
    getName() {
        return __WEBPACK_IMPORTED_MODULE_2__Utility_utils__["d" /* text */].mode === 'n' ? this.nameJ : this.name;
    },
    stealAttempt : __WEBPACK_IMPORTED_MODULE_3__TeamConstants__["a" /* default */].RUNNERS_DISCRETION,
    lineup : [],
    positions : {},
    manager : null,
    bench : [],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AtBat; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utility_Log__ = __webpack_require__(7);
...
class AtBat {
    constructor(text) {
        ...
        const log = new __WEBPACK_IMPORTED_MODULE_0__Utility_Log__["a" /* Log */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Services_Distribution__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Services_Animator__ = __webpack_require__(9);
...
Field.prototype = {
     ...
     */
    hasRunnersOn() {
        return this.first instanceof __WEBPACK_IMPORTED_MODULE_0__Model_Player__["a" /* Player */] || this.second instanceof __WEBPACK_IMPORTED_MODULE_0__Model_Player__["a" /* Player */] || this.third instanceof __WEBPACK_IMPORTED_MODULE_0__Model_Player__["a" /* Player */];
    },
    /**
     * @param swing
     * @returns {object}
    ...
    determineSwingContactResult(swing) {
         ...
         */
        const angles = __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].getSplayAndFlyAngle(
            x, y, swing.angle, eye,
            swing.timing,
        ...
        let landingDistance = __WEBPACK_IMPORTED_MODULE_1__Services_Distribution__["a" /* Distribution */].landingDistance(power, flyAngle, x, y);
        ...
        if (swing.fielder) {
            ...
            if (interceptRating > 0 && flyAngle > 4) {
                //caught cleanly?
                if (__WEBPACK_IMPORTED_MODULE_1__Services_Distribution__["a" /* Distribution */].error(fielder)) { //error
                    fieldingEase *= 0.5;
                    swing.error = true;
                    ...
                    if (game.umpire.count.outs < 2 && isOutfielder) {
                        const sacrificeThrowInTime = __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].fielderReturnDelay(
            ...
            if (!swing.caught) {
                ...
                let fieldingReturnDelay = __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].fielderReturnDelay(swing.travelDistance, throwingEase, fieldingEase, interceptRating);
                ...
                let baseRunningTime = __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].baseRunningTime(speed);
                    ...
                    if (swing.fieldersChoice) {
                        ...
                        if (force) {
                            ...
                            if (third && force === 'third' &&
                                __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].infieldThrowDelay(fielders.catcher) + throwingDelay < second.getBaseRunningTime() && outs < 3) {
                                throwingDelay += __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].infieldThrowDelay(fielders.catcher);
                            ...
                            if (second && force === 'second' &&
                                __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].infieldThrowDelay(fielders.third) + throwingDelay < first.getBaseRunningTime() && outs < 3) {
                                throwingDelay += __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].infieldThrowDelay(fielders.third);
                            ...
                            if (first && force === 'first' &&
                                __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].infieldThrowDelay(fielders.second) + throwingDelay < game.batter.getBaseRunningTime() && outs < 3) {
                                throwingDelay += __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].infieldThrowDelay(fielders.second);
        ...
        if (!__WEBPACK_IMPORTED_MODULE_3__Services_Animator__["a" /* Animator */].console) {
            __WEBPACK_IMPORTED_MODULE_3__Services_Animator__["a" /* Animator */]._ball.hasIndicator = true;
            __WEBPACK_IMPORTED_MODULE_3__Services_Animator__["a" /* Animator */].animateFieldingTrajectory(this.game);
        }
    },
    forcePlaySituation() {
        const first = this.first, second = this.second, third = this.third;
    ...
    getPolarDistance(a, b) {
        return __WEBPACK_IMPORTED_MODULE_2__Services_Mathinator__["a" /* Mathinator */].getPolarDistance(a, b);
    }
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return loadSkyShader; });
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Field__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Model_Team__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_Umpire__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Player__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Utility_Log__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Utility_utils__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Services_Animator__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Services_Mathinator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Services_Iterator__ = __webpack_require__(5);
...
Game.prototype = {
    ...
    init(m) {
        ...
        if (m) __WEBPACK_IMPORTED_MODULE_5__Utility_utils__["d" /* text */].mode = m;
        this.gamesIntoSeason = 72 + Math.floor(Math.random() * 72);
        this.field = new __WEBPACK_IMPORTED_MODULE_0__Model_Field__["a" /* Field */](this);
        this.teams.away = new __WEBPACK_IMPORTED_MODULE_1__Model_Team__["a" /* Team */](this);
        this.teams.home = new __WEBPACK_IMPORTED_MODULE_1__Model_Team__["a" /* Team */](this);
        this.log = new __WEBPACK_IMPORTED_MODULE_4__Utility_Log__["a" /* Log */]();
        this.log.game = this;
        this.debug = [];
        this.helper = __WEBPACK_IMPORTED_MODULE_5__Utility_utils__["c" /* helper */];
        while (this.teams.away.name === this.teams.home.name) {
            this.teams.away.pickName();
        }
        this.umpire = new __WEBPACK_IMPORTED_MODULE_2__Model_Umpire__["a" /* Umpire */](this);
        if (this.humanPitching()) {
            this.stage = 'pitch';
        }
        this.autoPitchSelect();
        __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].init();
        this.passMinutes(5);
    },
    get console() {
        return __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console;
    },
    set console(value) {
        __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console = value;
    },
    passMinutes(minutes) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console) __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].loop.setTargetTimeOfDay(time.h, time.m);
    },
    getInning() {
        return __WEBPACK_IMPORTED_MODULE_5__Utility_utils__["d" /* text */].mode === 'n' ? (this.inning + (this.half === 'top' ? 'オモテ' : 'ウラ')) : `${this.half.toUpperCase()} ${this.inning}`;
    },
    /**
    ...
    simulatePitchAndSwing(callback) {
        ...
        }, giraffe.field.hasRunnersOn() ? __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].TIME_FROM_SET + 2500 : __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].TIME_FROM_WINDUP + 2500);
    },
    /**
    ...
    windupThen(callback) {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console) {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console) {
                __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].loop.resetCamera();
            }
            windup.animate({width: 0}, this.field.hasRunnersOn() ? __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].TIME_FROM_SET : __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].TIME_FROM_WINDUP, () => {
                pitcher.windingUp = false;
                callback();
            });
        }
    ...
    autoPitch(callback) {
        ...
        let x, y, pitch;
        pitch = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].pitchLocation(count);
        x = pitch.x;
        y = pitch.y;

        this.windupThen(() => {
            !__WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console && $('.baseball.pitch').removeClass('hide');
            this.thePitch(x, y, callback);
        });
    },
    /**
    ...
    autoSwing(deceptiveX, deceptiveY, callback) {
        ...
        let x = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].centralizedNumber(), y = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].centralizedNumber();
        /**
        ...
        this.swingResult.x = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].cpuSwing(x, this.pitchInFlight.x, eye);
        this.swingResult.y = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].cpuSwing(y, this.pitchInFlight.y, eye * 0.75);

        this.batter.lastPitchCertainty = certainty;

        const swingProbability = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].swingLikelihood(eye, x, y, this.umpire, certainty);
    ...
    thePitch(x, y, callback, override) {
        ...
        if (this.stage === 'pitch') {
            if (override) {
                ...
                this.battersEye = __WEBPACK_IMPORTED_MODULE_5__Utility_utils__["d" /* text */].getBattersEye(this);

                const control = Math.floor(pitch.control - this.pitcher.fatigue/2);
                this.pitchTarget.x = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].pitchControl(this.pitchTarget.x, control);
                this.pitchTarget.y = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].pitchControl(this.pitchTarget.y, control);

                if (this.pitcher.throws === 'right') pitch.breakDirection[0] *= -1;

                const breakEffect = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].breakEffect(pitch, this.pitcher, this.pitchTarget.x, this.pitchTarget.y);
        ...
        if (this.stage === 'swing') {
            if (override) {
                ...
                if (x >= 0 && x <= 200) {
                    ...
                    const recalculation = __WEBPACK_IMPORTED_MODULE_8__Services_Mathinator__["a" /* Mathinator */].getAngularOffset(result, result.angle);
                    const precision = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].swing(eye);
                    ...
                    result.strike = __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].inStrikezone(pitch.x, pitch.y);
            ...
            if ((team.stealAttempt === __WEBPACK_IMPORTED_MODULE_1__Model_Team__["a" /* Team */].RUNNER_GO || team.stealAttempt === __WEBPACK_IMPORTED_MODULE_1__Model_Team__["a" /* Team */].RUNNERS_DISCRETION) && !this.opponentConnected) {
                const thief = field.getLeadRunner();
                if (thief instanceof __WEBPACK_IMPORTED_MODULE_3__Model_Player__["a" /* Player */]) {
                    let base;
                    switch (thief) {
                        case field.first:
                            base = 2;
                    ...
                    const discretion = team.stealAttempt === 'go' || __WEBPACK_IMPORTED_MODULE_7__Services_Distribution__["a" /* Distribution */].willSteal(pitch, this.pitcher.team.positions.catcher, thief, base);
                    if (discretion && validToSteal) {
                        thief.attemptSteal(this, base);
                    }
                    team.stealAttempt = __WEBPACK_IMPORTED_MODULE_1__Model_Team__["a" /* Team */].RUNNERS_DISCRETION;
                }
            }
    ...
    setBatAngle(x, y) {
        ...
        return __WEBPACK_IMPORTED_MODULE_8__Services_Mathinator__["a" /* Mathinator */].battingAngle(origin, swing);
    },
    debugOut() {
        ...
        __WEBPACK_IMPORTED_MODULE_9__Services_Iterator__["a" /* Iterator */].each(this.teams.home.positions, key => {
            const position = key;
    ...
    proceedToGame(SocketService, quickMode, spectateCpu) {
        ...
        if (game.humanControl === 'none' && game.console) {
            let n = 0;
            __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console = true;
            game.console = true;
            do {
                n++;
            ...
            __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console = game.console = false;
            log('sim ended');
            game.debugOut();
        } else if (quickMode === 7 && spectateCpu === 1) {
            __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].console = game.console = true;
            do {
                game.simulateInput(function (callback) {
                    typeof callback === 'function' && callback();
                });
            ...
            }, scalar * (game.field.hasRunnersOn() ? __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].TIME_FROM_SET + 2000 : __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].TIME_FROM_WINDUP + 2000));
        }
        ...
        if (!quickMode || quickMode === 7) {
            __WEBPACK_IMPORTED_MODULE_6__Services_Animator__["a" /* Animator */].loop.setTargetTimeOfDay(game.startTime.h, game.startTime.m);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Services_Iterator__ = __webpack_require__(5);
...
Manager.prototype = {
    ...
    makeLineup() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__Services_Iterator__["a" /* Iterator */].each(this.team.bench, (key, player) => {
            if (!player.number) {
    ...
    selectForSkill(pool, skillset, requiredThrowingHandedness) {
        if (this.team.bench.length || pool === this.team.positions) {
            ...
            let rating = 0;
            let index = 0;
            __WEBPACK_IMPORTED_MODULE_0__Services_Iterator__["a" /* Iterator */].each(pool, (key, player) => {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Umpire; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Utility_utils__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Model_Player__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Services_Distribution__ = __webpack_require__(4);
...
Umpire.prototype = {
    ...
    makeCall() {
        ...
        if (!isNaN(result.stoleABase)) {
            ...
            thief.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.STOLEN_BASE);
            switch (thief) {
                case field.first:
                    field.second = thief;
                    field.first = null;
                ...
                case field.third:
                    ...
                    thief.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.RUN);
                    this.runScores();
            }
        ...
        if (!isNaN(result.caughtStealing)) {
            ...
            thief.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.CAUGHT_STEALING);
            switch (thief) {
                case field.first:
                    field.first = null;
                    break;
        ...
        const inStrikezone = __WEBPACK_IMPORTED_MODULE_2__Services_Distribution__["a" /* Distribution */].inStrikezone(game.pitchInFlight.x, game.pitchInFlight.y);
            ...
            if (result.contact) {
                ...
                if (result.caught) {
                    ...
                    if (result.sacrificeAdvances.length && this.count.outs < 2) {
                        ...
                        game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.SACRIFICE);
                        this.advanceRunners(false, null, result.sacrificeAdvances);
                    } else {
                        batter.stats.batting.ab++;
                        if (result.flyAngle < 15) {
                            game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.LINEOUT);
                        } else {
                            game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.FLYOUT);
                        }
                    }
                    this.count.outs++;
                    fielder.stats.fielding.PO++;
                    ...
                    if (result.foul) {
                        ...
                        if (result.fieldersChoice && this.count.outs < 2) {
                            ...
                            fielder.stats.fielding.PO++;
                            pitcher.stats.pitching.IP[1]++;
                            game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.FIELDERS_CHOICE);
                            this.advanceRunners(false, result.fieldersChoice);
                            result.doublePlay && game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.GIDP);
                            this.reachBase();
                        ...
                        if (result.thrownOut) {
                            ...
                            fielder.stats.fielding.PO++;
                            pitcher.stats.pitching.IP[1]++;
                            game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.GROUNDOUT);
                            result.doublePlay && game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.GIDP);
                            if (this.count.outs < 3) {
                        ...
                        if (result.bases) {
                            if (!result.error) {
                                game.tally[game.half === 'top' ? 'away' : 'home'][__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.SINGLE]++;
                            ...
                            switch (bases) {
                                ...
                                case 1 :
                                    if (result.error) {
                                        game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.REACHED_ON_ERROR);
                                        break;
                                    }
                                    game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.SINGLE);
                                ...
                                case 2 :
                                    ...
                                    game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.DOUBLE);
                                    batter.stats.batting.h++;
                                ...
                                case 3 :
                                    ...
                                    game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.TRIPLE);
                                    batter.stats.batting.h++;
                                ...
                                case 4 :
                                    ...
                                    game.batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.HOMERUN);
        ...
        if (this.count.strikes > 2) {
            ...
            batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.STRIKEOUT);
            this.newBatter();
        }
        if (this.count.balls > 3) {
            ...
            this.says = 'Ball four.';
            this.count.balls = this.count.strikes = 0;
            batter.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.WALK);
            ...
            if (first) {
                if (second) {
                    if (third) {
                        ...
                        third.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.RUN);
            ...
            if (second && canAdvance('second')) {
                ...
                if (second != game.batter && !sacrificeAdvances
                    ...
                    if (game.batter != second) {
                        game.batter.recordRBI();
                        second.atBats.push(__WEBPACK_IMPORTED_MODULE_0__Utility_utils__["a" /* Log */].prototype.RUN);
                    }
                    game.field.third = null;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return samurai; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_Game__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Model_Team__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_Player__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Teams_Trainer__ = __webpack_require__(40);





const samurai = new __WEBPACK_IMPORTED_MODULE_1__Model_Team__["a" /* Team */]('no init');
samurai.name = 'Japan';
samurai.nameJ = '日本';

const darvish = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), johjima = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), ogasawara = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), nishioka = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), kawasaki = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), murata = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), matsui = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), ichiro = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), inaba = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai);

const matsuzaka = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), fukudome = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), aoki = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), abe = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai), iwamura = new __WEBPACK_IMPORTED_MODULE_2__Model_Player__["a" /* Player */](samurai);

const coach = new __WEBPACK_IMPORTED_MODULE_3__Teams_Trainer__["a" /* Trainer */]();
...
if (typeof window === 'object') {
    window.Baseball = __WEBPACK_IMPORTED_MODULE_0__namespace__["a" /* Baseball */];
}

/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__namespace__["a" /* Baseball */]);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Baseball; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_AtBat__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Model_Field__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_Game__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Model_Manager__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_Player__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_Team__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Model_Umpire__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Utility_utils__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Utility_text__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Services_Distribution__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Services_Mathinator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Services_Animator__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Services_Iterator__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Teams_Provider__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Teams_TeamJapan__ = __webpack_require__(19);
/* unused harmony reexport Game */
/* unused harmony reexport Player */
/* unused harmony reexport Team */
/* unused harmony reexport AtBat */
/* unused harmony reexport Field */
/* unused harmony reexport Manager */
/* unused harmony reexport Umpire */
/* unused harmony reexport Animator */
/* unused harmony reexport Distribution */
/* unused harmony reexport Iterator */
/* unused harmony reexport Mathinator */
/* unused harmony reexport text */
/* unused harmony reexport abbreviatePosition */
...
Baseball.model = {};
Baseball.model.Game = Baseball.Game = __WEBPACK_IMPORTED_MODULE_2__Model_Game__["a" /* Game */];
Baseball.model.Player = Baseball.Player = __WEBPACK_IMPORTED_MODULE_4__Model_Player__["a" /* Player */];
Baseball.model.Team = Baseball.Team = __WEBPACK_IMPORTED_MODULE_5__Model_Team__["a" /* Team */];

Baseball.service = {};
Baseball.service.Animator = __WEBPACK_IMPORTED_MODULE_11__Services_Animator__["a" /* Animator */];
Baseball.service.Distribution = __WEBPACK_IMPORTED_MODULE_9__Services_Distribution__["a" /* Distribution */];
Baseball.service.Iterator = __WEBPACK_IMPORTED_MODULE_12__Services_Iterator__["a" /* Iterator */];
Baseball.service.Mathinator = __WEBPACK_IMPORTED_MODULE_10__Services_Mathinator__["a" /* Mathinator */];

Baseball.util = {};
Baseball.util.text = __WEBPACK_IMPORTED_MODULE_7__Utility_utils__["d" /* text */];
Baseball.util.Log = __WEBPACK_IMPORTED_MODULE_7__Utility_utils__["a" /* Log */];
Baseball.util.text.abbreviatePosition = __WEBPACK_IMPORTED_MODULE_8__Utility_text__["a" /* abbreviatePosition */];

Baseball.teams = {};
Baseball.teams.Provider = __WEBPACK_IMPORTED_MODULE_13__Teams_Provider__["a" /* Provider */];
Baseball.teams.Japan = __WEBPACK_IMPORTED_MODULE_14__Teams_TeamJapan__["a" /* samurai */];

/* unused harmony default export */ var _unused_webpack_default_export = (Baseball);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mesh_Ball__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mesh_Mound__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mesh_Base__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mesh_FoulLine__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mesh_FoulPole__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mesh_Field__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__mesh_Grass__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__mesh_BaseDirt__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__mesh_BattersEye__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__mesh_Wall__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__mesh_Sky__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__mesh_Sun__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__scene_lighting__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Mesh_AbstractMesh__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Shaders_SkyShader__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__LoopConstants__ = __webpack_require__(10);
...
const AHEAD = () => {
    ...
    if (typeof THREE !== 'undefined') {
        return (ahead = new THREE.Vector3(0, __WEBPACK_IMPORTED_MODULE_15__LoopConstants__["b" /* VERTICAL_CORRECTION */], -60.5));
    }
};
const INITIAL_POSITION = () => {
    ...
    if (typeof THREE !== 'undefined') {
        return (initialPosition = new THREE.Vector3(0, __WEBPACK_IMPORTED_MODULE_15__LoopConstants__["b" /* VERTICAL_CORRECTION */], __WEBPACK_IMPORTED_MODULE_15__LoopConstants__["a" /* INITIAL_CAMERA_DISTANCE */]));
    }
};
...
class Loop {
    ...
    constructor(elementClass, background, Animator) {
        ...
        this.lighting = __WEBPACK_IMPORTED_MODULE_12__scene_lighting__["a" /* lighting */];
    ...
    main(background) {
        ...
        if (this.getThree()) {
            ...
            if (this.attach()) {
                __WEBPACK_IMPORTED_MODULE_12__scene_lighting__["a" /* lighting */].addTo(scene);
     ...
     */
    addStaticMeshes() {
        new __WEBPACK_IMPORTED_MODULE_5__mesh_Field__["a" /* Field */]().join(this);
        new __WEBPACK_IMPORTED_MODULE_1__mesh_Mound__["a" /* Mound */]().join(this);
        new __WEBPACK_IMPORTED_MODULE_6__mesh_Grass__["a" /* Grass */]().join(this);
        new __WEBPACK_IMPORTED_MODULE_6__mesh_Grass__["a" /* Grass */](this, true);
        new __WEBPACK_IMPORTED_MODULE_8__mesh_BattersEye__["a" /* BattersEye */]().join(this);
        const sun = new __WEBPACK_IMPORTED_MODULE_11__mesh_Sun__["a" /* Sun */](),
            sky = new __WEBPACK_IMPORTED_MODULE_10__mesh_Sky__["a" /* Sky */]();
        sun.derivePosition(sky);
        sky.join(this);
        sun.join(this);
        ...
        new __WEBPACK_IMPORTED_MODULE_9__mesh_Wall__["a" /* Wall */](this, -34);
        new __WEBPACK_IMPORTED_MODULE_9__mesh_Wall__["a" /* Wall */](this, -15);
        new __WEBPACK_IMPORTED_MODULE_9__mesh_Wall__["a" /* Wall */](this, 15);
        new __WEBPACK_IMPORTED_MODULE_9__mesh_Wall__["a" /* Wall */](this, 34);

        const b1 = new __WEBPACK_IMPORTED_MODULE_2__mesh_Base__["a" /* Base */](this, 'first');
        const b2 = new __WEBPACK_IMPORTED_MODULE_2__mesh_Base__["a" /* Base */](this, 'second');
        const b3 = new __WEBPACK_IMPORTED_MODULE_2__mesh_Base__["a" /* Base */](this, 'third');
        const b4 = new __WEBPACK_IMPORTED_MODULE_2__mesh_Base__["a" /* Base */](this, 'home');

        new __WEBPACK_IMPORTED_MODULE_7__mesh_BaseDirt__["a" /* BaseDirt */](this, b1);
        new __WEBPACK_IMPORTED_MODULE_7__mesh_BaseDirt__["a" /* BaseDirt */](this, b2);
        new __WEBPACK_IMPORTED_MODULE_7__mesh_BaseDirt__["a" /* BaseDirt */](this, b3);
        new __WEBPACK_IMPORTED_MODULE_7__mesh_BaseDirt__["a" /* BaseDirt */](this, b4);

        new __WEBPACK_IMPORTED_MODULE_3__mesh_FoulLine__["a" /* FoulLine */](this, 'left');
        new __WEBPACK_IMPORTED_MODULE_3__mesh_FoulLine__["a" /* FoulLine */](this, 'right');

        new __WEBPACK_IMPORTED_MODULE_4__mesh_FoulPole__["a" /* FoulPole */](this, 'left');
        new __WEBPACK_IMPORTED_MODULE_4__mesh_FoulPole__["a" /* FoulPole */](this, 'right');
    }
    ...
    test() {
        const ball = new __WEBPACK_IMPORTED_MODULE_0__mesh_Ball__["a" /* Ball */]();
        window.Ball = __WEBPACK_IMPORTED_MODULE_0__mesh_Ball__["a" /* Ball */];
        window.ball = ball;
        ball.setType('4-seam');
...
Loop.prototype.constructors = {
    Ball: __WEBPACK_IMPORTED_MODULE_0__mesh_Ball__["a" /* Ball */],
    Mound: __WEBPACK_IMPORTED_MODULE_1__mesh_Mound__["a" /* Mound */],
    Field: __WEBPACK_IMPORTED_MODULE_5__mesh_Field__["a" /* Field */]
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Services_Mathinator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Indicator__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Utility_helper__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__LoopConstants__ = __webpack_require__(10);
...
class Ball extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    /**
     *
     * @param loop
    ...
    animate() {
        ...
        if (frame) {
            ...
            pos.z += frame.z;
            if (pos.y < __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y) {
                this.bounce *= -1;
            }
    ...
    setType(type, handednessScalar) {
        const rpm = __WEBPACK_IMPORTED_MODULE_3__Utility_helper__["a" /* helper */].pitchDefinitions[type][4];
        const rotationAngle = __WEBPACK_IMPORTED_MODULE_3__Utility_helper__["a" /* helper */].pitchDefinitions[type][3];
    ...
    spawnIndicator() {
        ...
        const indicator = new __WEBPACK_IMPORTED_MODULE_2__Indicator__["a" /* Indicator */]();
    ...
    derivePitchingTrajectory(game) {
        ...
        const top = 200 - game.pitchTarget.y,
              ...
              flightTime = __WEBPACK_IMPORTED_MODULE_1__Services_Mathinator__["a" /* Mathinator */].getFlightTime(game.pitchInFlight.velocity,
                  __WEBPACK_IMPORTED_MODULE_3__Utility_helper__["a" /* helper */].pitchDefinitions[game.pitchInFlight.name][2]);

        const scale = SCALE;
        const origin = {
            x: (game.pitcher.throws == 'left' ? 1.5 : -1.5),
            y: __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 6,
        ...
        const terminus = {
            x: (left - 100) * scale,
            y: (100 - top + 2 * ARC_APPROXIMATION_Y_ADDITIVE) * scale + __WEBPACK_IMPORTED_MODULE_4__LoopConstants__["b" /* VERTICAL_CORRECTION */],
            z: INDICATOR_DEPTH
        };
        const breakingTerminus = {
            x: (breakLeft - 100) * scale,
            y: (100 - breakTop) * scale + __WEBPACK_IMPORTED_MODULE_4__LoopConstants__["b" /* VERTICAL_CORRECTION */],
            z: INDICATOR_DEPTH
        };
    ...
    deriveTrajectory(result, pitch) {
        ...
        const velocityVerticalComponent = Math.sin(__WEBPACK_IMPORTED_MODULE_1__Services_Mathinator__["a" /* Mathinator */].RADIAN * flyAngle) * velocity;
        // in feet
        ...
        while (counter--) {
            ...
            if (flightScalar < 0) {
                ...
                y = (origin.y * scale
                    ...
                    * ((100 - percent)/100)
                    + __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y * (progress);
            } else {
...
class Indicator extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop) {
        super();
        let n = 60;
        this.trajectory = [];
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Mound; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);


class Mound extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop) {
        super();
        this.getMesh();
        if (loop && loop.loop) {
    ...
    getMesh() {
        ...
        mesh.position.x = 0;
        mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 0.9;
...
class Base extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    ...
    getMesh() {
        ...
        mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 0.5;
        mesh.position.z -= 0;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FoulLine; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);


class FoulLine extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    ...
    getMesh() {
        ...
        mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 0.35;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FoulPole; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);


class FoulPole extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop, side) {
        super();
        this.side = side;
        this.getMesh();
    ...
    getMesh() {
        ...
        mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y;
...
class Field extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop) {
        super();
        this.getMesh();
        if (loop && loop.loop) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Grass; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);


class Grass extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    ...
    getMesh() {
        ...
        if (this.infield) {
            ...
            mesh.position.x = 0;
            mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 0.2;
            mesh.position.z = -62;
        } else {
            mesh.rotation.x = -90/180 * Math.PI;
            mesh.rotation.y = 0;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BaseDirt; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);


class BaseDirt extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop, base) {
        super();
        this.base = base;
        this.getMesh();
    ...
    getMesh() {
        ...
        mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 0.3;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BattersEye; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);


class BattersEye extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop) {
        super();
        this.getMesh();
        if (loop && loop.loop) {
    ...
    getMesh() {
        ...
        mesh.position.y = __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].WORLD_BASE_Y + 0;
        mesh.position.z -= 310;
...
class Wall extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Sky; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Shaders_SkyShader__ = __webpack_require__(15);



class Sky extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop) {
        super();
        this.getMesh();
        if (loop && loop.loop) {
    ...
    getMesh() {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].Sky) {
            __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].Sky = Object(__WEBPACK_IMPORTED_MODULE_1__Shaders_SkyShader__["a" /* loadSkyShader */])();
        }
        const sky = new __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */].Sky();
        this.sky = sky;
        this.mesh = sky.mesh;
...
class Sun extends __WEBPACK_IMPORTED_MODULE_0__AbstractMesh__["a" /* AbstractMesh */] {
    constructor(loop) {
        super();
        this.getMesh();
        if (loop && loop.loop) {
...
"use strict";
/* unused harmony export AbstractMesh */
/**
 * Each class should adhere to this pattern.
 * When a scene object has been positioned correctly and its trajectory set,
 * it should use ::join to attach itself to the scene.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TeamJapan__ = __webpack_require__(19);
...
Provider.prototype.teams = {
    TeamJapan: __WEBPACK_IMPORTED_MODULE_0__TeamJapan__["a" /* samurai */]
};
...
class Trainer {
    makePlayer(player, name, surname, surnameJ, nameJ, pitching, offense, defense, bats, throws, number) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__Services_Iterator__["a" /* Iterator */].each(player.pitching, (key, value) => {

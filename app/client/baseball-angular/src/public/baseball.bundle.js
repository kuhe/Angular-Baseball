    ...
    getSwing(swingResult) {
        ...
        if (swingResult.looking) {
            if (swingResult.strike) {
                result += `<span class="txt-orange">${text_text('Strike.')}</span>`;
            } else {
            ...
            if (swingResult.contact) {
                if (swingResult.foul) {
                    result += `<span class="txt-orange">${text_text('Fouled off.')}</span>`;
                } else {
                ...
                result += `<span class="txt-orange">${text_text('Swinging strike.')}</span>`;
            }
        }
        let steal = '';

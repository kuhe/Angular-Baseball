    ...
    renderFieldingTrajectory(game) {
        ...
        if (result.thrownOut || result.caught || result.bases) {
            if ((Math.random() < 0.15 && ball.airTime > 1.5)
                ...
                this.loop.setMoveTarget({x: 0, y: 6, z: Loop_Loop.INITIAL_CAMERA_DISTANCE}, 0.05);
            }
...
/* harmony default export */ var namespace = (Baseball);
...
/* harmony default export */ var baseball = __webpack_exports__["default"] = (Baseball);

...
coach.makePlayer(ogasawara, 'Michihiro', 'Ogasawara', '小笠原', '道大', 150, {eye: 96, power: 115, speed: 90},
    {catching: 50, fielding: 96, throwing: 85, speed: 70}, 'left', 'right', 36);

coach.makePlayer(nishioka, 'Tsuyoshi', 'Nishioka', '西岡', '剛', 150, {eye: 88, power: 75, speed: 92},
    {catching: 90, fielding: 88, throwing: 88, speed: 90}, 'right', 'right', 7);

coach.makePlayer(kawasaki, 'Munenori', 'Kawasaki', '川崎', '宗則', 150, {eye: 95, power: 75, speed: 92},
    {catching: 90, fielding: 98, throwing: 90, speed: 110}, 'left', 'right', 52);

coach.makePlayer(murata, 'Shuichi', 'Murata', '村田', '修一', 150, {eye: 82, power: 110, speed: 60},
...
coach.makePlayer(ichiro, 'Ichiro', 'Suzuki', 'イチロー', '', 115, {eye: 115, power: 98, speed: 99},
    {catching: 80, fielding: 110, throwing: 135, speed: 120}, 'left', 'right', 51);

coach.makePlayer(inaba, 'Atsunori', 'Inaba', '稲葉', '篤紀', 150, {eye: 92, power: 95, speed: 75},

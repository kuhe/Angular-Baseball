...
Distribution.prototype = {
    ...
    stealSuccess(pitch, catcher, thief, base) {
        ...
        return (thief.skill.offense.speed*2 + thief.skill.offense.eye*rand) + (base * -25 + 45)*rand + 10
             > (pitchBaseSpeedMultiplier * pitch.velocity * smoothedRand2
               + (catcher.skill.defense.catching + catcher.skill.defense.throwing) * rand2) + thief.fatigue;
    },
    /**
     * @param pitch {Object} game.pitchInFlight
     * @param catcher {Player}

...
import { Animator, Distribution, Mathinator } from 'baseball/Services/_services';
...
Game.prototype = {
    ...
    awaitPitch : function(callback, swingResult, half) {
    ...
    awaitSwing : function(x, y, callback, pitchInFlight, half) {
        if (this.opponentConnected) {
            this.waitingCallback = callback;

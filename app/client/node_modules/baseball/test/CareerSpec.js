...
describe('Game', function() {
    ...
    var asPitcher = Math.random() > 0.88;
    p = player;
    ...
    (function logCareer() {
        ...
        year = 'All ';
        totals.ba = format(totals.ba/9);
        totals.obp = format(totals.obp/9);
        totals.slg = format(totals.slg/9);
        totals.ops = format(totals.ops/9);
        totals.ERA = format(totals.ERA/9);
        totals.WHIP = format(totals.WHIP/9);
        totals.K9 = format(totals.K9/9);
        log('------');
        logYear(totals);
    })();

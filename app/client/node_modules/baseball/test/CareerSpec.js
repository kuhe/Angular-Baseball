...
describe('Game', function() {
    ...
    var runSeason = function(n) {
        ...
        player = new Player(game.teams.home, false);
        p = player;
        //if (player.skill.offense.speed > player.skill.offense.power) {
        //    game.teams.home.lineup[0] = p;
        //    game.teams.home.lineup[1] = p;
        //    game.teams.home.lineup[8] = p;
        //} else {
        //    game.teams.home.lineup[2] = p;
        //    game.teams.home.lineup[3] = p;
        //    game.teams.home.lineup[4] = p;
        //}
        game.teams.home.lineup = [p,p,p,p,p,p,p,p,p];

        player.skill.offense = offense;
        var games = 0;
        player.skill.offense.eye += Math.floor(Math.random()*7 - Math.random()*8);
        player.skill.offense.speed += Math.floor(Math.random()*5 - Math.random()*8);
        player.skill.offense.power += Math.floor(Math.random()*6 - Math.random()*8);
        do {
    ...
    it('I\'ve seen a lot in my life. I think it\'s time to retire.', function () {
        assert(300 < player.stats.batting.ab);
    });
});